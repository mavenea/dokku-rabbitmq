...
Forked from the Official rabbitmq plugin for dokku with a modified config enabling [webstomp plugin](https://www.rabbitmq.com/web-stomp.html) . It currently defaults to installing [rabbitmq:3.9.5-management](https://hub.docker.com/_/rabbitmq/).
